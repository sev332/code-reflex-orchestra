  ...
  // Navigation commands
  {
    ...
    extractor: (match, input) => {
      ...
      const appMap: Record<string, PageId> = {
        ...
        '3d studio': 'studio3d', '3d': 'studio3d', 'studio': 'studio3d',
        'illustrator': 'illustrator', 'draw': 'illustrator', 'vector': 'illustrator',
        'image editor': 'image', 'photos': 'image', 'images': 'image',
        'audio editor': 'audio', 'audio': 'audio', 'music': 'audio',
        'video editor': 'video', 'video': 'video',
        'presentations': 'presentations', 'slides': 'presentations', 'powerpoint': 'presentations',
        'code builder': 'ide', 'code': 'ide', 'ide': 'ide',
        'terminal': 'terminal', 'shell': 'terminal', 'console': 'terminal',
        'api studio': 'apistudio', 'api': 'apistudio', 'rest': 'apistudio',
        ...
        'files': 'files', 'file manager': 'files', 'explorer': 'files',
        'settings': 'settings', 'preferences': 'settings', 'config': 'settings',
        'map': 'map', 'maps': 'map', 'location': 'map',
        'comms': 'comms', 'communications': 'comms', 'chat': 'comms',
        'orchestration': 'orchestration', 'workflows': 'orchestration',
      };
