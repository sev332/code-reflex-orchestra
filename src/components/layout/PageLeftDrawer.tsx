...
import {
  ...
  CalendarListPanel, CalendarUpcomingPanel,
  TasksBoardPanel, TasksProjectsPanel, TasksAnalyticsPanel,
  FilesBrowsePanel, FilesRecentPanel, FilesStarredPanel,
  IDEFilesPanel, IDEGitPanel,
  IllustratorLayersPanel, IllustratorAssetsPanel,
  ImageGalleryPanel, ImageLayersPanel, ImageAdjustPanel, ImageAIToolsPanel,
  AudioTracksPanel, AudioEffectsPanel, AudioLibraryPanel,
  VideoTimelinePanel, VideoClipsPanel, VideoEffectsPanel,
  OrchestrationTasksPanel, OrchestrationRunsPanel, OrchestrationWorkflowsPanel,
  DocumentsStoragePanel, DocumentsTagsPanel,
  MapLayersPanel, MapPlacesPanel,
  SpreadsheetSheetsPanel, SpreadsheetFormulasPanel,
  NotesListPanel, NotesGraphPanel,
  Studio3DScenePanel,
  PresentationsSlidesPanel,
  CommsChannelsPanel, CommsDMsPanel,
  ...
  GenericSettingsPanel, GenericSearchPanel, GenericHistoryPanel,
} from './drawer-panels';
