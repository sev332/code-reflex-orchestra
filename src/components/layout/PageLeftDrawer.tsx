...
const drawerBlueprints: Record<string, DrawerBlueprint> = {
  'orchestration:tasks': { title: 'Task Queue', hint: 'Monitor active, queued, and completed nodes.', items: [{ label: 'Active Runs', meta: '4 running', icon: Play }, { label: 'Queued Jobs', meta: '11 pending', icon: Layers }, { label: 'Completed Today', meta: '27 success', icon: CheckCirclePanelIcon }] },
  'orchestration:runs': { title: 'Execution Runs', hint: 'Replay and inspect execution traces.', items: [{ label: 'Live Run Stream', meta: '2 pipelines', icon: Zap }, { label: 'Past Runs', meta: 'last 24h', icon: History }, { label: 'Failure Alerts', meta: '1 unresolved', icon: AlertPanelIcon }] },
  ...
  'orchestration:history': { title: 'Audit History', hint: 'Chronological orchestration activity.', items: [{ label: 'Recent Deploy', meta: '18m ago', icon: Upload }, { label: 'Chain Edit', meta: '42m ago', icon: FileText }, { label: 'Validation Pass', meta: '1h ago', icon: CheckCirclePanelIcon }] },
  ...
  'image:gallery': { title: 'Asset Gallery', hint: 'Recent edits and imported media.', items: [{ label: 'Recent Edits', meta: '18 assets', icon: Image }, { label: 'Reference Set', meta: '6 pinned', icon: Star }, { label: 'Exports', meta: '12 files', icon: DownloadPanelIcon }] },
  ...
  'image:ai-tools': { title: 'AI Image Ops', hint: 'Assistive generation and cleanup.', items: [{ label: 'Magic Erase', meta: 'ready', icon: Wand2 }, { label: 'Upscale x2', meta: 'queued', icon: ArrowUpPanelIcon }, { label: 'Style Transfer', meta: '5 presets', icon: SparkPanelIcon }] },
  ...
  'audio:ai-tools': { title: 'AI Audio Tools', hint: 'Cleanup and enhancement utilities.', items: [{ label: 'Noise Removal', meta: 'ready', icon: Wand2 }, { label: 'Stem Split', meta: '4 stems', icon: Layers }, { label: 'Auto Master', meta: 'preview', icon: SparkPanelIcon }] },
  ...
  'video:clips': { title: 'Clip Bin', hint: 'Source clips and b-roll.', items: [{ label: 'Interview A', meta: '11 clips', icon: Video }, { label: 'B-roll', meta: '42 clips', icon: Folder }, { label: 'Exports', meta: '6 renders', icon: DownloadPanelIcon }] },
  ...
  'video:ai-tools': { title: 'AI Video Tools', hint: 'Automated edits and captions.', items: [{ label: 'Auto Captions', meta: 'ready', icon: Wand2 }, { label: 'Scene Detect', meta: '34 cuts', icon: Search }, { label: 'Smart Reframe', meta: '9:16 preset', icon: SparkPanelIcon }] },
  ...
  'spreadsheet:formulas': { title: 'Formula Manager', hint: 'Reusable formulas and checks.', items: [{ label: 'Financial Pack', meta: '42 formulas', icon: Code2 }, { label: 'Lookup Set', meta: '18 formulas', icon: Search }, { label: 'Error Watch', meta: '3 flagged', icon: AlertPanelIcon }] },
  ...
  'spreadsheet:data': { title: 'Data Sources', hint: 'Connected imports and sync state.', items: [{ label: 'CSV Imports', meta: '7 sources', icon: Upload }, { label: 'Supabase Feed', meta: 'connected', icon: Database }, { label: 'Refresh Queue', meta: '2 jobs', icon: RefreshPanelIcon }] },
  'spreadsheet:ai-tools': { title: 'AI Analysis', hint: 'Forecasting and anomaly detection.', items: [{ label: 'Trend Forecast', meta: '90-day', icon: Wand2 }, { label: 'Anomaly Scan', meta: '5 alerts', icon: AlertPanelIcon }, { label: 'Insight Draft', meta: 'ready', icon: SparkPanelIcon }] },

  'tasks:board': { title: 'Task Board', hint: 'Kanban columns and priorities.', items: [{ label: 'In Progress', meta: '14 tasks', icon: KanbanSquare }, { label: 'Review', meta: '5 tasks', icon: EyePanelIcon }, { label: 'Blocked', meta: '2 tasks', icon: AlertPanelIcon }] },
  ...
  'tasks:analytics': { title: 'Task Analytics', hint: 'Cycle time and throughput.', items: [{ label: 'Velocity', meta: '41/wk', icon: BarChart3 }, { label: 'Avg Cycle', meta: '1.9 days', icon: Clock }, { label: 'Completion', meta: '94%', icon: CheckCirclePanelIcon }] },
  ...
  'presentations:ai-tools': { title: 'AI Slide Tools', hint: 'Auto-summarize and structure.', items: [{ label: 'Outline Draft', meta: 'ready', icon: Wand2 }, { label: 'Speaker Notes', meta: 'generated', icon: FileText }, { label: 'Design Balance', meta: 'pass', icon: SparkPanelIcon }] },

  'studio3d:scene': { title: 'Scene Graph', hint: 'Objects and hierarchy.', items: [{ label: 'Root Scene', meta: '18 nodes', icon: Box }, { label: 'Camera Rig', meta: '2 cameras', icon: EyePanelIcon }, { label: 'Lights', meta: '5 active', icon: Zap }] },
  ...
  'studio3d:shaders': { title: 'Shader Library', hint: 'PBR and custom shader presets.', items: [{ label: 'PBR Base', meta: 'active', icon: Palette }, { label: 'Glass Shader', meta: 'tuned', icon: Sliders }, { label: 'Neon FX', meta: 'preview', icon: SparkPanelIcon }] },
  ...
  'dashboard:widgets': { title: 'Widget Library', hint: 'Composable data widgets.', items: [{ label: 'Line Chart', meta: 'ready', icon: BarChart3 }, { label: 'Table Grid', meta: 'ready', icon: Table2 }, { label: 'Status KPI', meta: 'ready', icon: BadgePanelIcon }] },
  ...
  'browser:reading': { title: 'Reading List', hint: 'Queued long-form resources.', items: [{ label: 'AIMOS protocol', meta: '17 min', icon: FileText }, { label: 'UI Canon', meta: '9 min', icon: BookOpen }, { label: 'Security checklist', meta: '6 min', icon: ShieldPanelIcon }] },
